...
export interface NavSection {
  key: string;
  label: string;
  /** パスのプレフィックス（セクション内のどれかがアクティブかの判定用） */
...
const PATHS = {
  ...
  sun: 'M12 3v1.5M12 19.5V21M4.219 4.219l1.061 1.061M17.72 17.72l1.06 1.06M3 12h1.5M19.5 12H21M4.219 19.781l1.061-1.061M17.72 6.28l1.06-1.06M12 7.5a4.5 4.5 0 100 9 4.5 4.5 0 000-9z',
  ...
  calendarSimple: 'M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5',
  ...
  settings1: 'M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.313.686.645.87.074.04.147.083.22.127.324.196.72.257 1.075.124l1.217-.456a1.125 1.125 0 011.37.49l1.296 2.247a1.125 1.125 0 01-.26 1.431l-1.003.827c-.293.24-.438.613-.431.992a6.759 6.759 0 010 .255c-.007.378.138.75.43.99l1.005.828c.424.35.534.954.26 1.43l-1.298 2.247a1.125 1.125 0 01-1.369.491l-1.217-.456c-.355-.133-.75-.072-1.076.124a6.57 6.57 0 01-.22.128c-.331.183-.581.495-.644.869l-.213 1.28c-.09.543-.56.941-1.11.941h-2.594c-.55 0-1.02-.398-1.11-.94l-.213-1.281c-.062-.374-.312-.686-.644-.87a6.52 6.52 0 01-.22-.127c-.325-.196-.72-.257-1.076-.124l-1.217.456a1.125 1.125 0 01-1.369-.49l-1.297-2.247a1.125 1.125 0 01.26-1.431l1.004-.827c.292-.24.437-.613.43-.992a6.932 6.932 0 010-.255c.007-.378-.138-.75-.43-.99l-1.004-.828a1.125 1.125 0 01-.26-1.43l1.297-2.247a1.125 1.125 0 011.37-.491l1.216.456c.356.133.751.072 1.076-.124.072-.044.146-.087.22-.128.332-.183.582-.495.644-.869l.214-1.281z',
  settings2: 'M15 12a3 3 0 11-6 0 3 3 0 016 0z',
};

/** ダッシュボード + 園児一覧（トップレベル、セクション外） */
...
export const navSections: NavSection[] = [
  {
    key: 'records',
    label: '記録',
    activePrefix: '/records',
    defaultExpanded: true,
    items: [
      { href: '/records/growth', label: '成長記録', iconPaths: [PATHS.sun] },
      { href: '/records/incident', label: 'ヒヤリハット', iconPaths: [PATHS.warning] },
      { href: '/records/handover', label: '申し送り', iconPaths: [PATHS.chat] },
      { href: '/records/child-update', label: '園児情報更新', iconPaths: [PATHS.edit] },
    ],
  },
  {
    key: 'plans',
  ...
  },
  {
    ...
    defaultExpanded: true,
    items: [
      { href: '/documents', label: '書類一覧', iconPaths: [PATHS.document] },
      { href: '/documents/attendance', label: '出席簿', iconPaths: [PATHS.calendarSimple] },
    ],
  },
  {
    key: 'staff',
    label: '勤怠',
    activePrefix: ['/staff/shifts', '/staff/attendance', '/staff/coverage'],
    defaultExpanded: true,
    items: [
  ...
  },
  {
    key: 'management',
    label: '管理',
    activePrefix: ['/children/considerations', '/staff', '/rules', '/settings'],
    alwaysExpanded: true,
    roleFiltered: true,
    items: [
