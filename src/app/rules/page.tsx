...
function RuleManageTab() {
  const { rules, addRule, updateRule, deleteRule, openConfirm } = useApp();
  ...
  const handleDelete = async (id: string) => {
    ...
    const confirmed = await openConfirm({
      title: 'ルールを削除します',
      message: rule ? `「${rule.title}」を削除します。` : undefined,
      type: 'danger',
      confirmLabel: '削除する',
    });
                  ...
                  <div className="px-4 pb-4 border-t border-secondary/10">
                    ...
                    <div className="flex gap-2 mt-4 pt-3 border-t border-secondary/10">
                      <button
                        ...
                        className="flex items-center gap-1.5 min-h-11 px-4 rounded-lg text-sm text-paragraph hover:bg-secondary/20 transition-colors"
                      >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 min-h-12 px-4 rounded-lg text-sm text-alert hover:bg-alert/10 transition-colors"
                      >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
