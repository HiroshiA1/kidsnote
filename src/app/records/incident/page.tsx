      ...
      <main className="max-w-4xl mx-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-3">
            {savedMessages.map(message => {
              ...
              return (
                <div
                  key={message.id}
                  className="bg-alert/10 border-l-4 border-alert rounded-lg p-4 hover:shadow-md transition-shadow"
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="font-medium text-headline">{data.child_name}</span>
                      </div>
        ...
        {savedMessages.length === 0 && pendingMessages.length === 0 && (
          <div className="text-center py-20">
            ...
            <h2 className="text-lg font-medium text-headline mb-2">ヒヤリハット記録がありません</h2>
