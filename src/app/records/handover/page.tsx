      ...
      <main className="max-w-4xl mx-auto px-6 py-6 space-y-6">
          ...
          <div className="space-y-3">
            {savedMessages.map(message => {
              ...
              return (
                <div
                  key={message.id}
                  className="bg-secondary/20 border-l-4 border-button rounded-lg p-4 hover:shadow-md transition-shadow"
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <span className="text-xs text-paragraph/70">宛先: {data.target}</span>
                      </div>
                      <p className="text-sm text-headline">{data.message}</p>
                    </div>
        ...
        {savedMessages.length === 0 && pendingMessages.length === 0 && (
          <div className="text-center py-20">
            ...
            <h2 className="text-lg font-medium text-headline mb-2">申し送りがありません</h2>
